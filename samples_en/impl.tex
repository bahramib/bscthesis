...
The other is a \mintinline{CPP}{vector<string>} that contains all the YAML files in our multipass directory, that the
...
We could improve this matcher for the checker, with not matching functions declared with \mintinline{CPP}{void} as return value.
