...
% TODO: belerakni hogy az llvmet csak fejlesztettem és nem az egészet írtam, csatoltam a patch filet, stb
This chapter will cover the process of developing a Clang-Tidy checker, and the infrastructure that it is build on.
The developer should have an advanced knowledge of C++ and strong typing, minimal user experience with Linux and
