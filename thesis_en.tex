...
% Document's metadata
\title{Enhancing pattern matching-based static analysis of C-family software
projects with project-level knowledge} % title
...
\supervisor{Richárd Szalay} % internal supervisor's name
\affiliation{Ph.D.\ Student} % internal supervisor's affiliation
...
\department{Department of Programming Languages \\
	and Compilers} % department's name
\city{Budapest} % city
